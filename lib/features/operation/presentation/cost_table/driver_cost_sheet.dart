...
class DriverCostSheet extends StatefulWidget {
  ...
  const DriverCostSheet({super.key, this.sc});

  @override
  State<DriverCostSheet> createState() => _DriverCostSheetState();
}
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // 2. Header Row - Slides in from the left
              Row(
              ...
              // 3. Form Fields - Staggered entrance
              Column(
                    children: [
                      buildTextField(
                        label: 'Mandays',
        ...
        // 4. Bottom Button - Slides up from the bottom
